        ...
        tokens[levelname] = {
            'root': [
                ...
                (r'(abstract|as|async|await|base|break|by|case|catch|'
                 ...
                 r'out|override|params|private|protected|static|readonly|'
        ...
        tokens[levelname] = {
            'root': [
                ...
                (r'(abstract|and|as|base|catch|def|delegate|'
                 ...
                 r'protected|static|ref|sealed|static|'
    ...
    tokens = {
        'root': [
            ...
            (r'(as|abstract|callable|constructor|destructor|do|import|'
             ...
             r'partial|private|protected|static|return|set|static|'
...
class FSharpLexer(RegexLexer):
    ...
    keywords = [
        ...
        'namespace', 'new', 'null', 'of', 'open', 'override', 'private', 'static',
