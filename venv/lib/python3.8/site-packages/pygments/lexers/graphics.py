    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'resource', 'goto', 'inline', 'noinline', 'static',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'private','protected','static','reinterpret_cast','short','signed',
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(and|controls|tension|atleast|curl|if|else|while|for|do|'
             ...
             r'unravel|from|include|quote|static|static|private|restricted|'
