    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(abstract|boolean|byte|char|class|const|debugger|double|enum|export|'
             ...
             r'package|private|protected|static|short|static|super|synchronized|throws|'
...
class LassoLexer(RegexLexer):
    ...
    tokens = {
        ...
        'lasso': [
            ...
            (r'(static|protected|private|provide)(\s+)(([a-z_][\w.]*=?|[-+*/%])'
            ...
            (r'(/?)(Cache|Database_Names|Database_SchemaNames|'
             ...
             r'join|let|match|max|min|on|order|parent|protected|provide|static|'
...
class ObjectiveJLexer(RegexLexer):
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(@selector|@private|@protected|@static|@encode|'
