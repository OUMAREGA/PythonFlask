...
class HaxeLexer(ExtendedRegexLexer):
    ...
    keyword = (r'(?:function|class|static|var|if|else|while|do|for|'
               ...
               r'switch|case|default|static|private|try|untyped|'
    ...
    tokens = {
        ...
        'class-body': [
            ...
            include('meta'),
            (r'\}', Punctuation, '#pop'),
            (r'(?:static|static|private|override|dynamic|inline|macro)\b',
             Keyword.Declaration),
        ...
        'expr': [
            ...
            (r'(?:static|static|private|override|dynamic|inline)\b',
             Keyword.Declaration),
