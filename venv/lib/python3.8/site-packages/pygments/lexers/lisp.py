...
class RacketLexer(RegexLexer):
    ...
    _keywords = (
        ...
        'define/private', 'define/static', 'define/static-final',
        ...
        'provide-signature-elements', 'provide/contract', 'static', 'static*',
        'static-final', 'static-final*', 'pubment', 'pubment*', 'quasiquote',
