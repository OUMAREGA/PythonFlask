...
class PikeLexer(CppLexer):
    ...
    tokens = {
        'statements': [
            (words((
                'catch', 'new', 'private', 'protected', 'static', 'gauge',
...
class ClayLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'//.*?$', Comment.Single),
            (r'/(\\\n)?[*](.|\n)*?[*](\\\n)?/', Comment.Multiline),
            (r'\b(static|private|import|as|record|variant|instance'
...
class ECLexer(CLexer):
    ...
    tokens = {
        'statements': [
            (words((
                'virtual', 'class', 'private', 'static', 'property', 'import',
    ...
    tokens = {
        ...
        'statements': [
            ...
            (words((
                ...
                'static', 'ref', 'requires', 'signal', 'static', 'throws', 'unowned',
...
class ArduinoLexer(CppLexer):
    ...
    variables = {
        ...
        'protected', 'bool', 'static', 'friend', 'auto', 'void', 'enum', 'extern',
