...
class HybrisLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(extends|private|protected|static|static|throws|function|method|'
    ...
    def analyse_text(text):
        """static method and private method don't seem to be quite common
        elsewhere."""
        result = 0
        if re.search(r'\b(?:static|private)\s+method\b', text):
            result += 0.01
        return result
