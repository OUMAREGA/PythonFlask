    ...
    tokens = {
        'root': [
            ...
            (r'(abstract|const|enum|extends|final|implements|native|private|'
             r'protected|static|static|strictfp|super|synchronized|throws|'
    ...
    tokens = {
        'root': [
            ...
            (r'(var|delegate|construct|function|private|internal|protected|'
             r'static|abstract|override|final|static|extends|transient|'
    ...
    tokens = {
        'root': [
            ...
            (r'(abstract|annotation|as|break|by|catch|class|companion|const|'
             ...
             r'static|reified|return|sealed|set|super|tailrec|this|throw|'
    ...
    tokens = {
        'default': [
            ...
            (r'(\.attribute|\.bytecode|\.debug|\.deprecated|\.enclosing|'
             ...
             r'interface|native|private|protected|static|signature|static|'
	...
	tokens = {
		'root': [
			...
			(r'(as|break|case|catch|default|do|else|extends|extension|finally|fires|for|if|implements|instanceof|new|on|requires|return|super|switch|throw|throws|try|typeof|uses|while|with)\b',
			 Keyword),
			(r'(abstract|def|dispatch|final|native|override|private|protected|static|static|strictfp|synchronized|transient|val|var|volatile)\b', Keyword.Declaration),
			 (r'(boolean|byte|char|double|float|int|long|short|void)\b',
			  Keyword.Type),
			 (r'(package)(\s+)', bygroups(Keyword.Namespace, Text)),
