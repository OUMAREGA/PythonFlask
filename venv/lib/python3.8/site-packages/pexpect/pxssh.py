...
class pxssh (spawn):
    ...
    automatically accepts the remote certificate; or if you have static key
    ...
    off static key authentication. This will only work if the remote SSH server
...
#                + " -o 'UserKnownHostsFile /dev/null' ")
    ...
    def login (self, server, username=None, password='', terminal_type='ansi',
        ...
        if i==0:
            ...
            # static key stored in the 'known_hosts' cache.
            self.sendline("yes")
        ...
        elif i==1: # can occur if you have a static key pair set to authenticate.
