...
def public_factory(target, location, class_location=None):
    ...
    if isinstance(target, type):
        ...
        doc = (
            ...
            "This constructor is mirrored as a static API function; "
...
def as_interface(obj, cls=None, methods=None, required=None):
    ...
    Checks that ``obj`` implements static methods of ``cls`` or has members
    ...
    cls
      Optional, a type.  All static methods of cls are considered the
    ...
    required
      ...
      all static methods of the type are required.
