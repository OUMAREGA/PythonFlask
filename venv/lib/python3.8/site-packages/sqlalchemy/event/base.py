...
The static-facing ``Events`` serves as the base class for an event interface;
its static attributes represent different kinds of events.   These attributes
