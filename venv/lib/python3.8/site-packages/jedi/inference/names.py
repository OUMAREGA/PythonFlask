...
class AbstractNameDefinition(object):
    ...
    def get_defining_qualified_value(self):
        """
        Returns either None or the value that is static and qualified. Won't
        return a function, because a name in a function is never static.
        """
        return None
...
class StubNameMixin(object):
    def py__doc__(self):
        ...
        # else static. See e.g. stubs for `requests`.
        names = [self]
